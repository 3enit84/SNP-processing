...
import string
file = open("//cmh/user/Folders2/dgrigoryev/\
Genetics/aa_Control_SNPS_VCF_original.txt",'r')#VCF_tst.txt
newfile = open("//cmh/user/Folders2/dgrigoryev/Genetics/aa_Control_SNPS_VCF_original_prcssd.txt",'w')
